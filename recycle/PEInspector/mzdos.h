...
#define MZDOS_EXE_MAGIC 0x5a4d
#define IS_MZDOS_EXE 1
#define IS_NOT_MZDOS_EXE 1
...
1C-23	Reserved
24-25	OEM identifier (for e_oeminfo)
26-27	OEM information
28-3B	Reserved
3C-3D	File address of new exe header
*/
